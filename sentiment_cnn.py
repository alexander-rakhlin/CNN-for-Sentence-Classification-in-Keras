...
For "CNN-rand" and "CNN-non-static" get to 88-90%, and "CNN-static" - 85% after 2-5 epochs with following settings:
embedding_dim = 50          
filter_sizes = (3, 8)
num_filters = 10
...
if data_source == "keras_data_set":
    ...
    print("Adjust sequence length for actual size (shorter than Keras data set)")
